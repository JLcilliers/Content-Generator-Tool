...
# Heading generation prompt (for more detailed heading structures)
HEADING_STRUCTURE_PROMPT = """Generate an SEO-optimized heading structure for content about the given topic.

Rules:
1. H1 must align with the primary keyword naturally
2. Maximum 4 H2 sections
3. Maximum 2 H3 subheadings per H2
4. Each heading should be clear and descriptive
5. Include a one-line description of what each section should cover
6. No dates or years in any heading
7. Use natural language, not keyword-stuffed text
...
Return as JSON:
{
    "headings": [
        ...
        },
        {
            ...
            "description": "What this section covers",
            "subheadings": [
                {"level": "H3", "text": "Subheading", "description": "What to include"}
            ]
        }
    ]
}"""
...
FAQ_GENERATION_PROMPT = """Generate 4-6 FAQ questions for content about the given topic and keywords.

Rules:
1. Questions only - NO answers
2. Natural, conversational phrasing
3. Questions users would actually ask
4. Cover different aspects of the topic
5. Include the primary keyword naturally in at least one question
6. No dates or years in questions
